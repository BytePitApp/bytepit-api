...
from bytepit_api.dependencies.auth_dependencies import get_current_approved_organiser, get_current_verified_user, get_current_admin_or_approved_organiuser_user
...
async def get_all_competitions(
    ...
    return competition_service.get_every_competition()
...
@router.get("/random")
async def get_random_competition(
    current_user: Annotated[uuid.UUID, Depends(get_current_verified_user)]
):
